...
class CustomBinningStrategy(BinningStrategy):
    def __init__(self, binnig_definition):
        self.binnig_definition = binnig_definition

    def bin_feature(self, column, df):
        # may double check the function
        def assign_bin(value):
            for bin_label, bin_range in self.binnig_definition.items():
...
class BinaryBinnig(BinningStrategy):
    def __init__(self, binnig_definition):
        self.binning_definition = binnig_definition
