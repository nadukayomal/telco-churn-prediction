...
class MLflowTracker:
    ...
    def setup_mlflow(self):
        ...
        experiment_name = self.config.get('experiment_name', 'Telco Churn Analysis')
    ...
    def log_data_pipeline_metrics(self, dataset_info: Dict[str, Any]):
        ...
        try:
            ...
            # Dynamically log any extra keys passed in dataset_info
            expected_keys = [
                'total_rows', 'train_rows', 'test_rows', 'num_features', 
                'missing_values', 'outliers_removed', 'test_size', 'random_state', 
                'missing_strategy', 'outlier_method', 'encoding_applied', 'scaling_applied',
                'feature_names'
            ]
